...
public class VRNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VRNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VRNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VRNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VRNDateTimeConverter dateTimeConverter = new VRNStandardDateTimeConverter();

    public VRNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VRNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VRNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VRNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VRNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VRNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
