package com.company.MerniseServiceReference;
...
public class VRNKPSPublicSoap12
{
    interface VRNIWcfMethod
    {
        VRNExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(VRNExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public VRNKPSPublicSoap12(){}

    public VRNKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public VRNKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VRNExtendedSoapSerializationEnvelope envelope= new VRNExtendedSoapSerializationEnvelope(VRNExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,VRNExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,VRNExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new VRNIWcfMethod()
        {
            ...
            @Override
            public java.lang.Object ProcessResult(VRNExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(VRNIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,VRNExtendedSoapSerializationEnvelope envelope)
    {
